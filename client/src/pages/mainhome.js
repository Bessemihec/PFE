  ...
  return (
    <div className="homepage">
      ...
      <div className="container text-center">
        ...
        <div className='paragraphe'><strong>Postejob.com</strong> est le premier site d'emploi en Tunisie et le leader du marché de recrutement en ligne depuis sa création. Nous proposons des offres d'emploi dans toutes les régions du pays ainsi qu'à l'étranger, et les mettons à jour quotidiennement. Notre site d'emploi offre à tous les candidats la possibilité de trouver le travail qui correspond le mieux à leur profil en mettant à jour leur CV en ligne, en cherchant des offres d'emploi et en rédigeant un CV efficace qui met en avant leurs expériences et leurs atouts.

Si vous cherchez un travail dans l'une des régions de la Tunisie ou à l'étranger, <strong>Postejob.com</strong> vous propose en permanence des annonces d'emploi pour des postes vacants dans votre domaine d'activité. Les entreprises informatiques en Tunisie ou Offshore, les centres d'appels, les bureaux et les cabinets de recrutement et d'intérim sont les recruteurs les plus actifs sur le site.

En plus de proposer des offres d'emploi, <strong>Postejob.com</strong> dédie un espace pour les recruteurs qui cherchent des profils performants dans leurs secteurs d'activité. Vous trouverez également des annonces de formations en Tunisie sur notre site.

<strong>Postejob.com</strong>, le portail tunisien de l'emploi, accompagne les candidats et les recruteurs pour un avenir meilleur ! Nous sommes déterminés à fournir à nos utilisateurs une expérience en ligne unique et efficace pour trouver le travail ou le candidat idéal. </div>
